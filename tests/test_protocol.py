...
# Frames captured from a real WHOOP 4.0. The device serial is replaced with a
# placeholder and the CRC-32 recomputed, so the layout these offsets depend on is
# exactly as the strap sent it while no real hardware identifier is published.
HELLO_RESPONSE = (
    "aa8c004a2400230001049e03000000eee7e201085500004558414d504c4530310038653237383262373466343032383463"
    "3366343736313862383932353932303966653962643962653831373438346562323133396339060000000200000010000000"
    "2900000011000000060000000000000008060001000000000011000000020000000200000000000000"
    "55109302"
)
